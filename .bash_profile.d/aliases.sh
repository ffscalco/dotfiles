...
alias integrate_lowmem="unset_perf_vars && bundle exec rake db:migrate db:test:prepare && RAILS_ENV=test IGNORE_GC_PERFORMANCE_FILE=true time memusg bundle exec rspec spec/helpers/* spec/routing/* spec/lib/* spec/mailers/* spec/workers/* && RAILS_ENV=test IGNORE_GC_PERFORMANCE_FILE=true time memusg bundle exec rspec spec/models/* && RAILS_ENV=test IGNORE_GC_PERFORMANCE_FILE=true time memusg bundle exec rspec spec/controllers/* && RAILS_ENV=test IGNORE_GC_PERFORMANCE_FILE=true time memusg bundle exec rspec features/*_spec.rb && set_perf_vars && say 'integration finished'"
